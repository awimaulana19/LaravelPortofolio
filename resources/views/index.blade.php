              ...
              <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavDropdown">
                      ...
                      <ul class="navbar-nav ms-auto">
                          ...
                          @else
                              <li class="nav-item">
                                  <a class="nav-link text-light" href="/"><i class="bi bi-box-arrow-in-right"></i>
                                      Login</a>
                              </li>
                          @endauth
                      </ul>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-lg-6 col-md-12 m-about2">
                      ...
                      <p>{{ $data->deskripsi }}</p>
                      <a href="https://www.instagram.com/{{ $data->ig }}" target="_blank" type="button"
      ...
      <section id="projek" class="project">
          <div class="container">
              <div class="row ktk-atas">
                  ...
                  <div class="col-4">
                      <a href="/allproject/{{ $data->user->username }}" type="button" class="btn btn-danger">VIEW
                          ALL</a>
                  </div>
              </div>
                  ...
                  @foreach ($project as $dataproject)
                      <div class="col-lg-6 col-md-12 ktk">
                          ...
                          <div class="row kata">
                              ...
                              <a href="/showproject/{{ $dataproject->id }}" class="more">KNOW MORE <i
              ...
              <div class="row">
                  <div class="row pembungkus">
                      ...
                      <div class="col-6 d-flex align-self-center justify-content-center">
                          <a href="http://wa.me/{{ $data->wa }}" type="button" class="btn btn-danger"
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-4 d-flex justify-content-center pt-4">
                      <a href="https://www.instagram.com/{{ $data->ig }}" class="bi bi-instagram text-white"
                          target="_blank"></a>
                      <a href="https://twitter.com/{{ $data->twitter }}" class="bi bi-twitter text-white ps-4 pe-4"
                          target="_blank"></a>
                      <a href="http://wa.me/{{ $data->wa }}" class="bi bi-whatsapp text-white"
                          target="_blank"></a>
                  </div>
